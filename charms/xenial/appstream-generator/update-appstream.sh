...
rsync -a --verbose --delete-after "${WORKSPACE_DIR}/export/" --filter "protect media/main" --filter "protect media/universe" --filter "protect media/multiverse" --filter "protect media/restricted" --filter "protect data/xenial" --filter "protect html/xenial" --filter "protect html/yakkety" "${PUBLIC_DIR}/"
touch ${STAMP_FILE}
